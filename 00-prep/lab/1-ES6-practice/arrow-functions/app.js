...
console.log(joe);
// It does indeed break! was able to accomplish something similar with an arrow function by just returning an object literal
...
// I can add a method to the joe object literal, but if I use an arrow function to do it "this" loses scope
...
//   It refers to the 'joe' instance of Student
// 2. What is "this" when joe.scopeArrow() is invoked?
//   When the method is added as an arrow function, 'this' refers to the window object
// 3. Explain why "this" is different when an arrow function is used.
//   Arrow functions do not bind "this", so the scope bubbles up to the next nearest enclosing scope
